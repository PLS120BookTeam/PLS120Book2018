...
2. Define "population"
3. Define "parameter" and "random variable" and discuss their relationship to one another
3. Define statistical bias and give a few examples of situations that may lead to a biased estimator
4. Sketch an example sampling distribution (r = 10) for observations drawn from a normally distributed population, and sketch the corresponding normal pdf, using your sampling distribution to estimate its parameters.
